...
using namespace std;
const string CudaPhyNEOKernelSources::multipoleElectrostatics = "#define WARPS_PER_GROUP (THREAD_BLOCK_SIZE/TILE_SIZE)\n"
"\n"
"typedef struct {\n"
...
"}\n"
"";
const string CudaPhyNEOKernelSources::multipoleFixedField = "#define WARPS_PER_GROUP (THREAD_BLOCK_SIZE/TILE_SIZE)\n"
"\n"
"typedef struct {\n"
"    real4 posq;\n"
"    real3 field, dipole;\n"
...
"}\n"
"";
const string CudaPhyNEOKernelSources::multipoleInducedField = "#define WARPS_PER_GROUP (THREAD_BLOCK_SIZE/TILE_SIZE)\n"
"\n"
"typedef struct {\n"
"    real3 pos;\n"
...
"}\n"
"";
const string CudaPhyNEOKernelSources::multipolePme = "#define ARRAY(x,y) array[(x)-1+((y)-1)*PME_ORDER]\n"
"/**\n"
...
"}\n"
"";
const string CudaPhyNEOKernelSources::multipoles = "extern \"C\" __global__ void computeLabFrameMoments(real4* __restrict__ posq, int4* __restrict__ multipoleParticles, float* __restrict__ molecularDipoles,\n"
...
"}\n"
"";
const string CudaPhyNEOKernelSources::pmeMultipoleElectrostatics = "#define WARPS_PER_GROUP (THREAD_BLOCK_SIZE/TILE_SIZE)\n"
"\n"
"typedef struct {\n"
"    real3 pos, force, torque, inducedDipole, sphericalDipole;\n"
"    real q;\n"
...
"}\n"
"";
const string CudaPhyNEOKernelSources::sphericalMultipoles = "__device__ void buildQIRotationMatrix(real3 deltaR, real rInv, real (&rotationMatrix)[3][3]) {\n"
...
"#endif\n"
"";
const string CudaPhyNEOKernelSources::vectorOps = "/**\n"
