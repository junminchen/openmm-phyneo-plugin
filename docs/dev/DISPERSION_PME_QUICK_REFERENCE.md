...
## File Locations
- **Header:** `/platforms/cuda/src/ADMPPmeCudaKernels.h`
- **Implementation:** `/platforms/cuda/src/ADMPPmeCudaKernels.cpp`
- **CUDA Kernels:** `/platforms/cuda/src/kernels/multipolePme.cu`
- **API:** `/openmmapi/include/openmm/ADMPPmeForce.h` & `/openmmapi/src/ADMPPmeForce.cpp`
