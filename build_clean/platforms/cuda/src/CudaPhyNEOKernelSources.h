#ifndef OPENMM_CUDAPHYNEOKERNELSOURCES_H_
#define OPENMM_CUDAPHYNEOKERNELSOURCES_H_
...
class OPENMM_EXPORT CudaPhyNEOKernelSources {
public:
...
#endif /*OPENMM_CUDAPHYNEOKERNELSOURCES_H_*/
