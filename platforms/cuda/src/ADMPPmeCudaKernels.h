 ...
 */
class CudaCalcADMPPmeForceKernel : public CalcADMPPmeForceKernel {
public:
    CudaCalcADMPPmeForceKernel(std::string name, const Platform& platform, CudaContext& cu, const System& system);
    ~CudaCalcADMPPmeForceKernel();
    /**
...
private:
    ...
    CudaArray* labFramePolarizabilities;
    ...
    CudaArray* inducedDipoleField;
    CudaArray* inducedDipoleFieldGradient;
    CudaArray* extrapolatedDipoleField;
