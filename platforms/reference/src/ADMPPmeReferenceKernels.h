...
/**
 * This kernel is invoked by ADMPPmeForce to calculate the forces acting on the system and the energy of the system.
 */
class ReferenceCalcADMPPmeForceKernel : public CalcADMPPmeForceKernel {
public:
    ReferenceCalcADMPPmeForceKernel(std::string name, const Platform& platform, const System& system);
    ~ReferenceCalcADMPPmeForceKernel();
    /**
     * Initialize the kernel.
     * 
     * @param system     the System this kernel will be applied to
     * @param force      the ADMPPmeForce this kernel will be used for
     */
    void initialize(const System& system, const ADMPPmeForce& force);
    /**
     * Setup for ADMPPmeReferenceForce instance. 
     *
     * @param context        the current context
     *
     * @return pointer to initialized instance of ADMPPmeReferenceForce
     */
    ADMPPmeReferenceForce* setupADMPPmeReferenceForce(ContextImpl& context);
    /**
     ...
     * @param force      the ADMPPmeForce to copy the parameters from
     */
    void copyParametersToContext(ContextImpl& context, const ADMPPmeForce& force);
    /**
...
private:
    ...
    int numMultipoles;
    ADMPPmeForce::NonbondedMethod nonbondedMethod;
